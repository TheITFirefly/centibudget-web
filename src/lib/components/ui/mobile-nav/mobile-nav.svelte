...
<nav class="fixed top-0 w-full bg-background sm:hidden">
  ...
  <Popover.Root bind:open>
		<Popover.Trigger>
			...
			<Popover.Content sideOffset=0 class="bg-background/95 w-(--bits-popover-content-available-width) h-(--bits-popover-content-available-height) rounded-none border-none sm:hidden">
