<script lang="ts">
	...
	// Fixed for this dialog — this is always a salaried funding source.
	const fundingType: FundingType = 'Salary';
...
<Dialog.Root bind:open>
	<Dialog.Content class="sm:max-w-[500px]">
		<Dialog.Header>
			<Dialog.Title>Add Salaried Job</Dialog.Title>
			<Dialog.Description>Add a new salaried job to your budget.</Dialog.Description>
		</Dialog.Header>
		...
		<div class="grid gap-4 py-4">
			...
			<div class="grid gap-2">
				<Label for="pay-rate-input">Annual Salary</Label>
